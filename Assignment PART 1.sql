...
---- Question 3.(a)  Insert the following data into the table
...
---- Question 3.(b)  Add a couple of countries of your choice

insert into countries values('Saudi Arabia', 800, 'Riyadh'),
('UAE', 952, 'Dubai');
...
alter table product add constraint prod_supp_rel foreign key(supplier_ID) references suppliers(supplier_ID);
alter table Stock add constraint prod_Stoc_rel foreign key(Product_ID) references product(Product_ID);

---- Question 6. Enter some records into the three tables.

insert into product values( 100, '1969 Harley Davidson Ultimate Chopper', 11111),
(101, '2003 Harley-Davidson Eagle Drag Bike',22222),
(102,'1965 Aston Martin DB5',33333),
(103,'1968 Ford Mustang',44444),
(104,'1936 Mercedes-Benz 500K Special Roadster',55555);

insert into Suppliers values( 11111, 'Min Lin Diecast', 'Europe'),
(22222, 'Red Start Diecast','England'),
(33333,'Classic Metal Creations','Spain'),
(44444,'Studio M Art Models','Italy'),
(55555,'Welly Diecast Productions','France');

insert into Stock values( 1001, 100, 5),
( 1002, 101, 7),
( 1003, 102, 9),
( 1004, 103, 11),
( 1005, 104, 4);
...
create unique index Uni_empid on emp(emp_no);
